...
# Run for django-engine-pro
python3 -m scripts.epistemic.run_pipeline django-engine-pro

# Preview without writing changes
python3 -m scripts.epistemic.run_pipeline django-engine-pro --dry-run

# Run for all plugins
python3 -m scripts.epistemic.run_pipeline --all

# Run only specific stages
python3 -m scripts.epistemic.run_pipeline django-engine-pro --stages 1,2
```
...
1. Run the pipeline:
```bash
cd <repo-root> && python3 -m scripts.epistemic.run_pipeline django-engine-pro
```
