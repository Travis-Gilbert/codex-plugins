...
1. Read `knowledge/claims.jsonl` and filter for claims where domain starts with `django.frontend` or `django.templates`.
2. For active claims with confidence > 0.8: treat them as authoritative additions to your review checklist.
...
5. After completing your review, note which claims you applied and whether each was confirmed or contradicted.
